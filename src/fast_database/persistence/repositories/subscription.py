...
:class:`~fast_database.persistence.repositories.repository.IRepository` with ``model=Subscription``.

Usage:
    >>> from fast_database.persistence.repositories.subscription import SubscriptionRepository
