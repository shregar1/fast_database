...
All notable changes to **fast-db-models** will be documented in this file.
...
- **factory_boy example:** `PlanFactory` in `fast_db_models.factories` (optional `[dev]` extra includes `factory-boy`).
